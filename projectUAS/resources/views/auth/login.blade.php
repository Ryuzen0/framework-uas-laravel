...
<section class="bg-light p-3 p-md-4 p-xl-5 d-flex align-items-center min-vh-100">
                    ...
                    <div class="row g-0">
                        <div class="col-12 col-md-6">
                            <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy"
                                src="{{ asset('img/A fine dining experience in a Michelin-starred restaurant.jpg') }}" alt="Welcome back you've been missed!">
                        </div>
                                ...
                                <div class="card-body p-3 p-md-4 p-xl-5">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-5">
                                                ...
                                                <h1 class=" text-center" style="font-family:'Mea Culpa',cursive; color: #d4af37;">TulipRestaurant</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <form method="POST" action="/login">
                                        ...
                                        <div class="row gy-3 overflow-hidden">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button class="btn btn-lg" type="submit" style="background-color:#0a1a44; color: white;">Sign in</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="row">
                                        <div class="col-12">
                                            <p class="mb-0 mt-3 text-secondary text-center">
