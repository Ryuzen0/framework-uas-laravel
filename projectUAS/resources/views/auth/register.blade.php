...
<head>
    ...
    <link
        ...
        <style>
            body {
                background-image: url('{{ asset('img/background_image.jpg') }}');
...
<body>
<section class="bg-light p-3 p-md-4 p-xl-5 d-flex align-items-center min-vh-100 shadow-lg">
                    ...
                    <div class="row g-0 flex-md-row-reverse">
                        <div class="col-12 col-md-6">
                            <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy"
                                src="{{ asset('/img/Schick essen gehen.jpg') }}" alt="Welcome back you've been missed!">
                        </div>
                                ...
                                <div class="card-body p-3 p-md-4 p-xl-5">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-5">
                                                <div class="text-center mb-4">
                                                    <a href="/register">
                                                        <img class="tulip-icon"
                                                            src="{{ asset('img/deceased_192dp_D4AF37_FILL0_wght400_GRAD0_opsz48.svg') }}"
                                                            alt="tulip">
                                                    </a>
                                                </div>
                                                <h1 class=" text-center"
                                                    style="font-family: 'Mea Culpa', cursive; color: #d4af37;">
                                                    Registration</h1>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form action="/register" method="POST">
                                        ...
                                        <div class="row gy-3 overflow-hidden">
                                            ...
                                            <div class="col-12">
                                                <div class="form-floating mb-3">
                                                    <input type="password" class="form-control"
                                                        ...
                                                        value="" placeholder="password confirmation" required>
                                            ...
                                            <div class="col-12">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label text-secondary" for="iAgree">
                                                        I agree to the <a href="/condition-terms"
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button class="btn"  style="background-color:#0a1a44; color: white;" type="submit">Sign
                                                        up</button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <p class="mb-0 mt-3 text-secondary text-center">Already have an
