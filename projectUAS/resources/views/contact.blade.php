...
<body>
    ...
    @include('components.carouselMenu', [
        'image' => "img/Want to get a refund on a nonrefundable hotel room_ Here's what you need to know_.jpg",
        'title' => 'Contact Us',
        'text' =>
            'We would love to hear from you! Whether you have questions, feedback, or inquiries about our menu and services, our team is here to assist you. Reach out to us through any of the following channels:',
    ])
    {{-- End Carousel --}}

    {{-- Contact --}}
    <section class="py-5 my-5 py-md-5 py-xl-8">
        <div class="container">
            <div class="heading">
                <h1 class="mb-3 text-center">Get in Touch</h1>
                <p class="lead fs-4 text-center mb-5 mb-md-6 mb-lg-7">Feel free to reach out to us with any
                    questions,
                    comments, or feedback. We're here to help and look forward to hearing from you!</p>
            </div>
                        ...
                        <div class="card-body p-0">
                            <div class="row gy-3 gy-md-4 gy-lg-0">
                                <div class="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover"
                                    style="--bsb-overlay-opacity: 0.7; background-image: url('./assets/img/contact-img-1.webp'); background-color: #0a1a44;">
                                    <div class="row align-items-lg-center justify-content-center h-100">
                                        <div class="col-11 col-xl-10">
                                            <div class="contact-info-wrapper py-4 py-xl-5">
                                                <h2 class="h1 mb-3 text-light" style="font-family: Mea Culpa, cursive">
                                                    Contact Information
                                                </h2>
                                                <p class="lead fs-4 text-light opacity-75 mb-4 mb-xxl-5">We're here
                                                    to
                                                ...
                                                <div class="d-flex mb-4 mb-xxl-5">
                                                    ...
                                                    <div>
                                                        ...
                                                        <address class="mb-0 text-light opacity-75">Australia
                                                        </address>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-12 col-xxl-6">
                                                        <div class="d-flex mb-0">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="mb-0">
                                                                    <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none"
                                                                        href="mailto:demo@yourdomain.com">tulip@gmail.com</a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="d-flex mb-1">
                                                            <p class="text-light fw-bold mb-0 me-5">Mon - Wed</p>
                                                            <p class="text-light opacity-75 mb-0">8am - 4pm</p>
                                                        </div>
                                                        <div class="d-flex">
                                                            <p class="text-light fw-bold mb-0 me-5">Thurs - Fri</p>
                                ...
                                <div class="col-12 col-lg-6">
                                    <form name="submit-to-google-sheet"
                                        action="https://script.google.com/macros/s/AKfycbyyRlve1XhCqjp5vsWbFTGajg21hg1d_vVzSy0_kiioYeDdaAlzy68ydEDqae_EHzdq0w/exec"
                                        method="POST">
                                            ...
                                            <div class="col-12">
                                                <form action="#!">
                                                    <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="d-grid">
                                                                <button class="btn btn-primary btn-lg kirim"
                                                                    type="submit">Send
                                                                    Message</button>
    ...
    <script>
        const scriptURL =
            'https://script.google.com/macros/s/AKfycbyyRlve1XhCqjp5vsWbFTGajg21hg1d_vVzSy0_kiioYeDdaAlzy68ydEDqae_EHzdq0w/exec';
        ...
        // FIX 2: hide loading & alert at start
